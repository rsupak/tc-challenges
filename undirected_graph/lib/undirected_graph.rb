...
class UndirectedGraph
  ...
  # if there is no edge throws an ArgumentError
  ...
  # returns true if a vertex was added (false if the vertex was already in the graph)
  def add_vertex!(vertex)
    vertices[vertex] = true unless @vertices[vertex]
  end
